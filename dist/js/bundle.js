...
function forms(formSelector, modalTimerId) {
    ...
    function  showThanksModal(message) {
        ...
        Object(_modal__WEBPACK_IMPORTED_MODULE_0__["methodOpen"])('.modal', modalTimerId);
        ...
        setTimeout(() => {
            thanksModal.remove();
            Object(_modal__WEBPACK_IMPORTED_MODULE_0__["metHodClose"])('.modal');
...
window.addEventListener('DOMContentLoaded', () => {
   ...
   const modalTimerId = setTimeout(() => Object(_modules_modal__WEBPACK_IMPORTED_MODULE_1__["methodOpen"])('.modal', modalTimerId), 500000);
