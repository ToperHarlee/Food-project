...
/******/ 	return __webpack_require__(__webpack_require__.s = "./js/project.js");
/******/ })
/************************************************************************/
/******/ ({
...
/*!*****************************************************!*\
  !*** C:/Users/Вера/node_modules/process/browser.js ***!
  \*****************************************************/
...
function calculates() {
  ...
  var storageDefault = function storageDefault() {
...
} //module.exports = calculates;


/* harmony default export */ __webpack_exports__["default"] = (calculates);
...
/* harmony import */ var _services_services__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ../services/services */ "./js/services/services.js");
...
function cards() {
  var parentEl = document.querySelector('.menu .container'),
      img = document.getElementsByTagName('img'),
      subtitle = document.querySelector('.menu__item-subtitle'),
      descr = document.querySelector('.menu__item-descr'),
      span = document.getElementsByTagName('span');

  var CardMaker = /*#__PURE__*/function () {
    function CardMaker(imgsrc, imgalt, title, text, price, convert) {
  ...
  var ValuteCard = /*#__PURE__*/function (_CardMaker) {
    _inherits(ValuteCard, _CardMaker);

    var _super = _createSuper(ValuteCard);

    function ValuteCard(imgsrc, imgalt, title, text, price, parentEl, convert) {
      var _this;

      _classCallCheck(this, ValuteCard);

      for (var _len2 = arguments.length, classes = new Array(_len2 > 7 ? _len2 - 7 : 0), _key2 = 7; _key2 < _len2; _key2++) {
        classes[_key2 - 7] = arguments[_key2];
      }

      _this = _super.call.apply(_super, [this, imgsrc, imgalt, title, text, price, parentEl].concat(classes));
      _this.convert = convert; // сюда можно статическое значение но пока оставлю так

      _this.converterValute();

      return _this;
    }

    _createClass(ValuteCard, [{
      key: "converterValute",
      value: function converterValute() {
  ...
  Object(_services_services__WEBPACK_IMPORTED_MODULE_13__["getResource"])(' http://localhost:3000/menu').then(function (data) {
...
function forms(formSelector, modalTimerId) {
  ...
  function bindPostData(form) {
    form.addEventListener('submit', function (e) {
      ...
      var formData = new FormData(form); // FormData собранные данные от пользователя из формы(создается в виде обьекта)

      var json = JSON.stringify(Object.fromEntries(formData.entries())); // entries - возвращает данные в виде массива с подмассивов с двумя значениями(ключ-значение)
  ...
  function showThanksModal(message) {
    ...
    Object(_modal__WEBPACK_IMPORTED_MODULE_8__["methodOpen"])('.modal', modalTimerId); //showModal(modalOpen, modal);
    ...
    setTimeout(function () {
      thanksModal.remove();
      Object(_modal__WEBPACK_IMPORTED_MODULE_8__["metHodClose"])('.modal');
      prevModalDialog.classList.add('show');
      prevModalDialog.classList.remove('hide'); //closeModal(modal);
    }, 3000);
  }
...
/*!*****************************!*\
  !*** ./js/modules/modal.js ***!
  \*****************************/
/*! exports provided: default, methodOpen, metHodClose */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "methodOpen", function() { return methodOpen; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "metHodClose", function() { return metHodClose; });
/* harmony import */ var core_js_modules_es_array_for_each__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! core-js/modules/es.array.for-each */ "./node_modules/core-js/modules/es.array.for-each.js");
/* harmony import */ var core_js_modules_es_array_for_each__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es_array_for_each__WEBPACK_IMPORTED_MODULE_0__);
...
function methodOpen(modalSelector, modalTimerId) {
  var modal = document.querySelector(modalSelector); //whatShow.style.display = 'block';

  modal.classList.add('show');
  modal.classList.remove('hide'); //whatShow.classList.toggle('show');
...
function metHodClose(modalSelector) {
  var modal = document.querySelector(modalSelector); //whatClose.style.display = 'none';

  modal.classList.remove('show');
  modal.classList.add('hide'); //whatClose.classList.toggle('show');
...
function modal(openSelector, modalSelector, modalTimerId) {
  var modal = document.querySelector(modalSelector),
      ...
      modalOpen = document.querySelectorAll(openSelector); //closeBtn = document.querySelector('.modal__close');
  ...
  function showModal(element) {
    element.forEach(function (btn) {
      btn.addEventListener('click', function () {
        return methodOpen(modalSelector, modalTimerId);
      });
    });
  ...
  closeModal(modal); //************************************* 044 Модификации модального окна ************************************
...
function sliders(_ref) {
  ...
  var showCurrentSlideNums = function showCurrentSlideNums() {
    if (slide.length < 10) {
      total.textContent = "0".concat(slide.length);
      current.textContent = "0".concat(currentSlide);
    } else {
      total.textContent = "".concat(slide.length);
  ...
  var sliderCountNum = function sliderCountNum() {
    if (slide.length < 10) {
      current.textContent = "0".concat(currentSlide);
    } else {
      current.textContent = currentSlide;
  ...
  var dotsMoveClick = function dotsMoveClick() {
  ...
  var replaceNotNum = function replaceNotNum(property) {
  ...
  function setClock(selector, endtime) {
    ...
    function updateClock() {
      ...
      if (t.total <= 0) {
        ...
        var endTimer = document.createElement('div');
...
window.addEventListener('DOMContentLoaded', function () {
  var modalTimerId = setTimeout(function () {
    return Object(_modules_modal__WEBPACK_IMPORTED_MODULE_2__["methodOpen"])('.modal', modalTimerId);
  }, 500000);
  ...
  Object(_modules_timer__WEBPACK_IMPORTED_MODULE_3__["default"])('.timer', '2020-12-31');
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 2:
            ...
            throw new Error("Couldn not fetch ".concat(url, ", status: ").concat(res.status));
